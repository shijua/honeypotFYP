...
echo "OpenCanary HTTP: http://${CLIENT_TARGET_HOST:-127.0.0.1}:8082/"
echo "OpenCanary SSH:  ssh -p 2224 root@${CLIENT_TARGET_HOST:-127.0.0.1}"
echo "OpenCanary Redis:${CLIENT_TARGET_HOST:-127.0.0.1}:6380"
echo "OpenCanary MySQL:${CLIENT_TARGET_HOST:-127.0.0.1}:3307"
echo "OpenCanary Git:  ${CLIENT_TARGET_HOST:-127.0.0.1}:9418"
